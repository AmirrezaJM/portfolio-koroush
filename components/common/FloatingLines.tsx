...
export default function FloatingLines({
    ...
    useEffect(() => {
        ...
        // NOTE: Fixed `alpha: false` to true, we want it transparent to not block background entirely if not needed, although reactbits explicitly sets it black in code if no gradient is passed.
